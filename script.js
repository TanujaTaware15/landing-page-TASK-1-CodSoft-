...
tl1.from('.container2 .skeleton  h5',{
    opacity:0,
    stagger:0.1,
    scrollTrigger:{
        trigger:'.container2 .skeleton  h5',
        scroller:'body',
        start:'top 60%',
        end:'top 60%',
        scrub:2
...
tl1.from('.container2 .skeleton .text ',{
    opacity:0,
    y:70,
    stagger:0.2,
    scrollTrigger:{
        trigger:'.container2 .skeleton .text',
        scroller:'body',
        start:'top 60%',
        end:'top 60%',
        scrub:2
...
tl1.from('.container2 .skeleton .text-short ',{
    opacity:0,
    y:70,
    stagger:0.2,
    scrollTrigger:{
        trigger:'.container2 .skeleton .text-short',
        scroller:'body',
        start:'top 60%',
        end:'top 60%',
        scrub:2
